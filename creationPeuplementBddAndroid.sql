...
--
-- Host: localhost    Database: gsbAndroid
-- ------------------------------------------------------
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MOTIF` (
  `MOTIF_NUM` int(11) NOT NULL AUTO_INCREMENT,
  `MOTIF_LIBELLE` varchar(150) NOT NULL,
...
INSERT INTO `MOTIF` VALUES (1,'Comportement'),(2,'Respect des consignes'),(3,'Insubordination'),(4,'Absences'),(5,'Retards');
...
INSERT INTO `OFFRIR` VALUES ('a131',1,'AMOPIL7',4),('a131',1,'EVILR7',3),('a131',1,'JOVAI8',1),('a131',1,'PHYSOI8',4),('a131',1,'POMDI20',5),('a131',6,'3MYC7',1),('a131',6,'ADIMOL9',2),('a131',6,'AMOPIL7',3),('a131',6,'AMOX45',4),('a131',6,'AMOXIG12',5),('b13',7,'3MYC7',3),('b13',7,'AMOX45',5),('b13',7,'BACTIV13',3),('b13',7,'DEPRIL9',5),('b13',8,'LITHOR12',1),('b13',8,'PIRIZ8',4),('b13',8,'POMDI20',2);
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_BILAN` varchar(510) NOT NULL,
  `MOTIF_NUM` int(11) NOT NULL,
  `RAP_COEFCONFIANCE` varchar(300) NOT NULL,
  `RAP_DATE_VISITE` date NOT NULL,
  `RAP_DATE_CREATION` date NOT NULL,
  `RAP_EST_LU` tinyint(1) NOT NULL,
  PRIMARY KEY (`RAP_NUM`),
  KEY `FK_RAPPORT_VISITE_PRATICIEN` (`PRA_NUM`),
  KEY `FK_RAPPORT_VISITE_VISITEUR` (`VIS_MATRICULE`),
  KEY `FK_RAPPORT_VISITE_MOTIF` (`MOTIF_NUM`),
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF` FOREIGN KEY (`MOTIF_NUM`) REFERENCES `MOTIF` (`MOTIF_NUM`),
...
INSERT INTO `RAPPORT_VISITE` VALUES (1,'a131',1,'Bilan peu correcte, a revoir d\'urgence',1,'4.80','2017-05-12','2017-04-12',1),(2,'a17',2,'Bilan assez bon',2,'8.66','2017-04-08','2017-04-08',0),(3,'a55',3,'Bilan sans commentaire',5,'2.33','2017-05-22','2017-04-22',0),(4,'a131',4,'Bilan moyen, peut mieux faire',2,'5.50','2017-05-17','2017-05-17',1),(5,'a131',6,'Bilan correct, continuez ainsi',5,'7.59','2017-05-09','2017-05-09',1),(6,'a131',1,'Bilan peu correct',1,'4.04','2017-05-25','2017-05-25',1),(7,'b13',5,'Assez bon bilan',2,'7.90','2017-05-09','2017-05-25',0),(8,'b13',38,'Bilan moyen',5,'5.01','2017-05-25','2017-05-25',1);
...
INSERT INTO `TYPE_PRATICIEN` VALUES ('MH','Médecin Hospitalier','Hopital ou clinique'),('MV','Médecine de Ville','Cabinet'),('PH','Pharmacien Hospitalier','Hopital ou clinique'),('PO','Pharmacien Officine','Pharmacie'),('PS','Personnel de sant','Centre paramédical');
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_MDP` varchar(200) DEFAULT NULL,
  `VIS_DERNIERCONNEXION` date DEFAULT NULL,
...
INSERT INTO `VISITEUR` VALUES ('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08','E','SW','ab4f63f9ac65152575886860dde480a1','2017-05-25'),('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('a55','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06','E','SW','ab4f63f9ac65152575886860dde480a1','2017-05-25'),('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b34','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b4','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b50','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('c14','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('c54','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY','ab4f63f9ac65152575886860dde480a1',NULL),('e22','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18','P','SW','ab4f63f9ac65152575886860dde480a1',NULL),('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('e5','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY','ab4f63f9ac65152575886860dde480a1',NULL),('e52','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('f39','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29','P','SW','ab4f63f9ac65152575886860dde480a1',NULL),('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY','ab4f63f9ac65152575886860dde480a1',NULL),('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('h13','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19','P','SW','ab4f63f9ac65152575886860dde480a1',NULL),('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('j45','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('j50','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY','ab4f63f9ac65152575886860dde480a1',NULL),('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('k53','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('l46','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('m35','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('n42','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p32','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21','P','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p40','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p41','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p7','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('p8','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY','ab4f63f9ac65152575886860dde480a1',NULL),('r58','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30','O','SW','ab4f63f9ac65152575886860dde480a1',NULL),('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03','E','SW','ab4f63f9ac65152575886860dde480a1',NULL),('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29','N','SW','ab4f63f9ac65152575886860dde480a1',NULL),('t55','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29','S','SW','ab4f63f9ac65152575886860dde480a1',NULL),('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29','O','GY','ab4f63f9ac65152575886860dde480a1',NULL);
...
-- Dump completed on 2017-05-25 18:06:53
